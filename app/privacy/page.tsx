...
export const metadata: Metadata = {
  ...
  description: "How Biloo and Hisab Technologies collect, use, protect and manage personal information across the public website and Biloo ERP services.",
...
export default function PrivacyPolicyPage() {
  return (
    <LegalDocumentPage
      ...
      description="This policy explains how Biloo, operated by Hisab Technologies, handles personal information when you visit our website, request a demo, contact us, create an account or use Biloo ERP."
      ...
      sections={[
        {
          ...
          content: <>
            <p>Biloo is a business operating system developed and operated by Hisab Technologies in Addis Ababa, Ethiopia. In this policy, “Biloo,” “Hisab Technologies,” “we,” “us” and “our” refer to the entity responsible for the public website and the Biloo ERP service.</p>
            <p>This policy applies when you visit hisabtech.com, request a demonstration, contact our team, create or manage a Biloo account, or use features that link to this policy. A separate customer agreement, data-processing agreement or implementation statement may provide additional terms for an organization using Biloo ERP.</p>
            <div className="legal-note"><strong>Business customer data</strong>When an organization uses Biloo ERP to manage its own records, that organization determines what business data is entered and who may access it. We process that data to provide the contracted service and according to the customer’s instructions, subject to applicable law.</div>
          </>,
        },
        {
          ...
          content: <>
            ...
            <ul>
              ...
              <li>Billing and transaction references required to administer paid services. Complete payment-card details are handled by the applicable payment provider rather than stored directly by Biloo unless specifically stated.</li>
            </ul>
        ...
        },
        {
          ...
          content: <>
            <ul>
              <li>Provide, maintain and secure the website, Biloo ERP accounts and requested business workflows.</li>
        ...
        },
        {
          ...
          content: <>
            ...
            <p>Information may also be shared with authorized administrators of the organization that controls a Biloo workspace, during a corporate restructuring with appropriate safeguards, or where disclosure is required by law, court order or a valid government request.</p>
        ...
        },
        {
          ...
          content: <>
            <p>Biloo may use cloud and technology providers operating in other countries. As a result, information may be processed outside the country where it was collected. We assess provider security and use appropriate contractual, organizational and technical safeguards based on the information and applicable requirements.</p>
        ...
        },
        {
          ...
          content: <>
            <p>Subject to applicable law and the role Biloo has in the relevant processing, you may request access to personal information, correction of inaccurate information, deletion, restriction, objection, portability, or withdrawal of consent.</p>
            <p>For information held inside an employer’s or customer organization’s Biloo workspace, contact that organization first because it normally controls the business record and user permissions. We will support the organization where required.</p>
            <p>To submit a privacy request, email <a href="mailto:mahir@hisabtech.com?subject=Biloo%20privacy%20request">mahir@hisabtech.com</a>. We may need to verify identity and clarify the scope before responding.</p>
          </>,
        },
        {
          ...
          content: <>
            <p>The Biloo business service is not directed to children. We do not knowingly invite children to create business accounts or submit personal information through the public website.</p>
