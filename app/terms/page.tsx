...
export const metadata: Metadata = {
  title: "Website Terms",
  description: "Terms governing access to the Biloo website, public resources, demo requests, accounts and related services provided by Hisab Technologies.",
...
export default function WebsiteTermsPage() {
  return (
    <LegalDocumentPage
      ...
      title="Straightforward terms for using the Biloo website and services."
      description="These terms explain the rules that apply when you browse Biloo’s public website, request information, create an account or access a Biloo service. Customer contracts may add service-specific commitments."
      ...
      sections={[
        {
          ...
          content: <>
            <p>These Website Terms govern access to hisabtech.com, Biloo public resources, demo and contact forms, account-registration journeys and any service that links to these terms. By accessing or using those services, you agree to these terms.</p>
            <p>If you use Biloo for an organization, you confirm that you are authorized to act for that organization. A signed subscription agreement, order form, implementation statement, data-processing agreement or other customer contract will control if it expressly conflicts with these Website Terms for the contracted service.</p>
        ...
        },
        {
          ...
          content: <>
            <p>You may use the public website to learn about Biloo, review resources, compare features, request a demonstration, contact the team and access available account entry points. Information is provided for general product evaluation and business education.</p>
        ...
        },
        {
          ...
          content: <>
            <p>You may not use Biloo or the website to:</p>
            <ul>
              ...
              <li>Use the service for harassment, fraud, spam or activity that creates material risk for Biloo, customers or third parties.</li>
            </ul>
        ...
        },
        {
          ...
          summary: "Ownership remains with the customer while Biloo receives the rights needed to operate the service.",
          content: <>
            <p>Customers retain their rights in data submitted to their Biloo workspace. The customer grants Biloo the limited rights necessary to host, process, transmit, back up, secure and otherwise handle that data to provide the requested service and support.</p>
            ...
            <p>Biloo may generate service metadata, diagnostic information and aggregated statistics that do not identify a customer or individual. Such information may be used to operate, secure and improve the service.</p>
          </>,
        },
        {
          ...
          content: <>
            <p>Biloo, Hisab Technologies and their licensors own the website, software, designs, documentation, trademarks, logos and other protected materials, excluding customer data and third-party content. These terms provide a limited, revocable, non-exclusive right to use the service for its intended purpose; they do not transfer ownership.</p>
            <p>You may download or share public resources for internal evaluation or educational use where the resource permits it, but you may not remove ownership notices, resell materials, publish misleading modified versions or use Biloo branding in a way that suggests endorsement without permission.</p>
            <p>Feedback may be used to improve Biloo without an obligation to compensate the person providing it, provided we do not publicly identify confidential customer information without authorization.</p>
          </>,
        },
        {
          ...
          content: <>
            <p>Biloo may link to or integrate with payment providers, communications services, banks, cloud providers or other third parties. Third-party services are governed by their own terms and privacy practices. Biloo does not control their independent systems or guarantee uninterrupted third-party availability.</p>
        ...
        },
        {
          ...
          content: <>
            ...
            <p>Questions may be sent to <a href="mailto:mahir@hisabtech.com?subject=Biloo%20website%20terms">mahir@hisabtech.com</a> or addressed to Hisab Technologies, Addis Ababa, Ethiopia.</p>
          </>,
        },
      ]}
    />
