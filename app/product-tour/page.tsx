...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Biloo ERP Product Tour",
    description: "See how Biloo connects daily operations to live management visibility across desktop and mobile.",
    url: "/product-tour",
    type: "website",
  },
};
      ...
      <div className="product-tour-phase-2-4">
        <section className="marketing-page-hero product-tour-hero">
          <div className="product-tour-hero-copy">
            ...
            <p>Move through Biloo’s major product areas and see how sales, inventory, finance and reporting become one reliable operating picture—across desktop and mobile.</p>
        ...
        <section className="marketing-cta marketing-cta-v2">
          <div><span>Need a tour based on your business?</span><h2>See Biloo through the workflows your company uses every day.</h2><p>We can focus the demonstration on your industry, team structure, branches, reporting requirements and current operational challenges.</p></div>
