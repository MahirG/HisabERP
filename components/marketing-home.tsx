...
function FinancialOperatingSystemPreview() {
  return (
    <div className="hisab-fintech-preview" aria-label="Biloo ERP financial operating system preview">
      <div className="hisab-preview-window">
        <div className="hisab-preview-topbar">
          <div className="hisab-preview-brand"><img src="/hisab-logo.svg" alt="" width="26" height="26" /><span>Biloo ERP</span></div>
    ...
    <MarketingPageShell>
      <section className="marketing-hero hisab-fintech-hero" aria-labelledby="home-hero-title">
        <div className="marketing-hero-copy">
          <span className="marketing-eyebrow">Biloo ERP · Financial operating system</span>
      ...
      <section className="home-final-recommendations"><div className="marketing-section-heading marketing-section-heading-wide"><span>Learn, verify and connect</span><h2>Continue from product evaluation to a confident business decision.</h2><p>Use practical business guidance, understand the company behind Biloo ERP and choose the most convenient way to speak with the team.</p></div><div className="home-final-recommendation-grid"><Link href="/resources"><span>Business Learning Center</span><strong>Improve the operating routine</strong><small>Read practical guides for cash flow, customer debt, stock accuracy, monthly close, ERP selection and migration.</small><b>Explore business guides →</b></Link><Link href="/about"><span>About Biloo</span><strong>Know who is building the product</strong><small>Review the mission, product principles, leadership and standards guiding Biloo ERP development.</small><b>Meet Biloo →</b></Link><Link href="/request-demo?source=homepage-final"><span>Focused conversation</span><strong>Use your real business context</strong><small>Request a guided demonstration or contact Biloo directly through phone, email or WhatsApp.</small><b>Choose the next step →</b></Link></div></section>
